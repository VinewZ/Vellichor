...
const TrackRow = memo(function TrackRow({
  ...
  return (
    <div className="flex flex-col gap-2 p-3 border-2 border-outline [content-visibility:auto] [contain-intrinsic-size:auto_64px]">
      ...
      {showProgress ? (
        <div>
          <div className="w-full h-2 border border-outline">
            <div
...
export function Mixer() {
  ...
  return (
    <section className="border-2 border-outline p-6 shadow-section bg-background min-w-0 overflow-x-hidden">
      <div className="flex items-center justify-between pb-3 border-b-2 border-outline mb-4">
        ...
        <span className="px-2 py-0.5 text-[10px] font-mono font-bold uppercase border border-outline">
          {runIndices.length === 0
            ? "Nothing rendered"
      ...
      {selectedIndices.length > 0 && book ? (
        <div className="flex flex-col gap-2 mb-4 max-h-72 overflow-y-auto overflow-x-hidden pr-1 min-w-0">
